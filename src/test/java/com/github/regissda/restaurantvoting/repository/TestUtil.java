...
public class TestUtil {
    ...
    public static final User USER_1 = new User("testuser1", "testuser1", Role.ROLE_ADMIN, Role.ROLE_USER);
    public static final User USER_2 = new User("testuser2", "testuser2", Role.ROLE_ADMIN);
    public static final User USER_3 = new User("testuser3", "testuser3", Role.ROLE_USER);
    ...
    public static User getCreatedUser() {
        return new User("createdUser", "password", Role.ROLE_USER);
    }

    public static User getUpdatedUser(User user) {
        return new User(user.getLogin(), "updatedPassword", Role.ROLE_USER, Role.ROLE_ADMIN);
    }
